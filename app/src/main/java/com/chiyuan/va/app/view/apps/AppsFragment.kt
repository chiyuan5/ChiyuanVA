...
import com.chiyuan.va.app.databinding.FragmentAppsBinding
import com.chiyuan.va.app.util.InjectionUtil
import com.chiyuan.va.app.util.ShortcutUtil
...
import com.chiyuan.va.app.view.main.MainActivity
import java.util.*
...
class AppsFragment : Fragment() {
    ...
    companion object {
        private const val TAG = "CVA_AppsFragment"
    ...
    override fun onStart() {
        try {
            ...
            try {
                ChiyuanVACore.get().addServiceAvailableCallback {
    ...
    private fun stopApk(info: AppInfo) {
        try {
            MaterialDialog(requireContext()).show {
                ...
                positiveButton(R.string.done) {
                    try {
                        ChiyuanVACore.get().stopPackage(info.packageName, userID)
