...
import com.chiyuan.va.app.databinding.ActivityMainBinding
import com.chiyuan.va.app.util.Resolution
import com.chiyuan.va.app.util.inflate
import com.chiyuan.va.app.view.apps.AppsFragment
import com.chiyuan.va.app.view.base.LoadingActivity
import com.chiyuan.va.app.view.fake.FakeManagerActivity
import com.chiyuan.va.app.view.list.ListActivity
import com.chiyuan.va.app.view.setting.SettingActivity
...
class MainActivity : LoadingActivity() {
    ...
    companion object {
        private const val TAG = "CVA_MainActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        try {
            ...
            try {
                ChiyuanVACore.get().onBeforeMainActivityOnCreate(this)
            } catch (e: Exception) {
            ...
            try {
                ChiyuanVACore.get().onAfterMainActivityOnCreate(this)
            } catch (e: Exception) {
            ...
            when (item.itemId) {
                R.id.main_git -> {
                    val intent =
                            Intent(
                                    Intent.ACTION_VIEW,
                                    Uri.parse("https://github.com/ALEX5402/NewChiyuanVA")
                            )
                ...
                R.id.main_tg -> {
                    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/newchiyuanvaa"))
                    startActivity(intent)
                }
                R.id.fake_location -> {
