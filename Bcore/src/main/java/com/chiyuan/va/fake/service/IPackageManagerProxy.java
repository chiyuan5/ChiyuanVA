...
import com.chiyuan.va.fake.FakeCore;
...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    protected void inject(Object baseInvocation, Object proxyInvocation) {
        ...
        Object systemContext = BRActivityThread.get(ChiyuanVACore.mainThread()).getSystemContext();
    ...
    public static class ResolveIntent extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ResolveInfo resolveInfo = ChiyuanVACore.getBPackageManager().resolveIntent(intent, resolvedType, flags, ChiyuanVACore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
    ...
    public static class ResolveService extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            String resolvedType = (String) args[1];
            int flags = MethodParameterUtils.toInt(args[2]);
            ResolveInfo resolveInfo = ChiyuanVACore.getBPackageManager().resolveService(intent, flags, resolvedType, ChiyuanVACore.getUserId());
            if (resolveInfo != null) {
                return resolveInfo;
            }
            return method.invoke(who, args);
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = ChiyuanVACore.getBPackageManager().getProviderInfo(componentName, flags, ChiyuanVACore.getUserId());
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo receiverInfo = ChiyuanVACore.getBPackageManager().getReceiverInfo(componentName, flags, ChiyuanVACore.getUserId());
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo activityInfo = ChiyuanVACore.getBPackageManager().getActivityInfo(componentName, flags, ChiyuanVACore.getUserId());
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ServiceInfo serviceInfo = ChiyuanVACore.getBPackageManager().getServiceInfo(componentName, flags, ChiyuanVACore.getUserId());
            if (serviceInfo != null)
                return serviceInfo;
            if (AppSystemEnv.isOpenPackage(componentName)) {
                return method.invoke(who, args);
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ApplicationInfo> installedApplications = ChiyuanVACore.getBPackageManager().getInstalledApplications(flags, ChiyuanVACore.getUserId());
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[0]);
            List<PackageInfo> installedPackages = ChiyuanVACore.getBPackageManager().getInstalledPackages(flags, ChiyuanVACore.getUserId());
    ...
    public static class QueryContentProviders extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[2]);
            List<ProviderInfo> providers = ChiyuanVACore.getBPackageManager().
                    queryContentProviders(ChiyuanVACore.getAppProcessName(), ChiyuanVACore.getBUid(), flags, ChiyuanVACore.getUserId());
    ...
    public static class QueryBroadcastReceivers extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ResolveInfo> resolves = ChiyuanVACore.getBPackageManager().queryBroadcastReceivers(intent, flags, type, BActivityThread.getUserId());
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = ChiyuanVACore.getBPackageManager().resolveContentProvider(authority, flags, BActivityThread.getUserId());
            if (providerInfo == null) {
                return method.invoke(who, args);
            }
            return providerInfo;
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == ChiyuanVACore.getHostUid()) {
                args[0] = BActivityThread.getBUid();
                uid = (int) args[0];
            }
            String[] packagesForUid = ChiyuanVACore.getBPackageManager().getPackagesForUid(uid);
    ...
    public static class getComponentEnabledSetting extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = ChiyuanVACore.getBPackageManager().getApplicationInfo(packageName,0, BActivityThread.getUserId());
